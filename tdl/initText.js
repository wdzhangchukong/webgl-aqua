...
tdl.provide('tdl.initText');

tdl.initText = tdl.initText || {};
...
var texture;
tdl.initText.initTexCanvas = function initTexCanvas() {
    if (typeof wx !== 'undefined') {
        console.log("xxxxxxxxxxxxxxxx 1 ");
    showtexcanvas = wx.createCanvas();
        showtexcanvas.width = wxhelper.GetWindowSize().width;
        showtexcanvas.height = wxhelper.GetWindowSize().height;
  }else {
      showtexcanvas = document.getElementById('canvas');
  }
...
var oldNum = -1;
tdl.initText.setTexCanvas = function setTexCanvas(num) {
     if (oldNum != num) {
         ...
         oldNum = num;
         var text = num + "";
         context.fillText(text, showtexcanvas.width * 0.25, showtexcanvas.height * 0.5);
         setTextureCanvas();
         console.log("xxxxxxxxxxxxxxx " + num);
     }
 }

tdl.initText.renderTexCanvas = function renderTexCanvas() {
